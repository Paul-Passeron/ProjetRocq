...
\chapter{Introduction} 
	...
	\begin{itemize}
		...
		\item Le rapport : \texttt{passeron\_rousseau.pdf}
		...
		\item Un fichier \LaTeX contenant le corps du rapport : \texttt{passeron\_rousseau.tex}
	\end{itemize}

	Le tout est contenu dans une archive passeron\_rousseau.tar.gz.
	...
	\begin{enumerate}
		...
		\item Faire la commande : \texttt{make pdf}
	\end{enumerate}
	...
	\begin{enumerate}
		\item Se placer dans le dossier extrait de l'archive.
		\item Faire la commande : \texttt{make clean}
		\item Faire la commande : \texttt{make archive}
	\end{enumerate}

	Une fois cela fait, un nouveau fichier \texttt{passeron\_rousseau.tar.gz} devrait être généré.
...
\chapter{Conclusion}
	...
	À l'exception de la question \textbf{4.d} de \textbf{l'exercice 1}, tout a été prouvé.
